...
import com.byk.ggkt.client.activity.CouponInfoFeignClient;
import com.byk.ggkt.client.course.CourseFeignClient;
import com.byk.ggkt.client.user.UserInfoFeignClient;
import com.byk.ggkt.exception.GgktException;
...
import com.byk.ggkt.order.mapper.OrderInfoMapper;
import com.byk.ggkt.order.service.OrderDetailService;
import com.byk.ggkt.order.service.OrderInfoService;
import com.byk.ggkt.utils.AuthContextHolder;
import com.byk.ggkt.utils.OrderNoUtils;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public OrderInfoVo getOrderInfoById(Long id) {
        ...
        BeanUtils.copyProperties(orderInfoVo,orderInfoVo);
    ...
    //订单列表
    @Override
    public Map<String, Object> serviceOrderInfoPage(Page<OrderInfo> pageParam, OrderInfoQueryVo orderInfoQueryVo) {
