...
import com.byk.ggkt.vod.service.VideoService;
import com.byk.ggkt.vod.service.VodService;
import com.byk.ggkt.vod.utils.ConstantPropertiesUtil;
...
public class VodServiceImpl implements VodService {
    ...
    public String uploadVideo() {
        ...
        //设置视频文件在本地路径
        request.setMediaFilePath("D:\\项目\\硅谷课堂\\尚硅谷-02-为什么使用数据库及数据库常用概念.mp4");
        //任务流
