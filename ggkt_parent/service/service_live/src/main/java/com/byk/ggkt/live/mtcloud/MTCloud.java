...
package com.byk.ggkt.live.mtcloud;

import com.byk.ggkt.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "50305";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "a10cbe5d771d94c2a922e7d3ec436f09";
