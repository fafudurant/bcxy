package com.byk.ggkt.wechat.service.impl;

import com.alibaba.nacos.client.naming.utils.CollectionUtils;
import com.byk.ggkt.client.course.CourseFeignClient;
import com.byk.ggkt.model.vod.Course;
import com.byk.ggkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long id) {
        String openid = "oduO758rCDJvI_sX6oRmu6x6AcJk";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("7rs2VqmwKWxjnCsi-BCrO4gOtxkkUrL88tk7S9UegKM")//模板id
                .url("http://ggktbyk.free.idcfengye.com/#/pay/"+id)//点击模板消息要访问的网址
                .build();
        ...
        templateMessage.addData(new WxMpTemplateData("keyword3", "2022-09-01", "#272727"));
    ...
    private String aboutUs(Map<String, String> param) {
        StringBuffer msg = this.text(param, "硅谷课堂现开设Java、HTML5前端+全栈、大数据、全链路UI/UE设计、人工智能、大数据运维+Python自动化、Android+HTML5混合开发等多门课程；同时，通过视频分享、谷粒学苑在线课堂、大厂学苑直播课堂等多种方式，满足了全国编程爱好者对多样化学习场景的需求，已经为行业输送了大量IT技术人才。");
        return msg.toString();
    }
