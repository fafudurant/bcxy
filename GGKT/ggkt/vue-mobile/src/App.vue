    ...
    methods: {
        wechatLogin() {
            ...
            if (token == '') {
                ...
                window.location = 'http://ggktbyk.free.idcfengye.com/api/user/wechat/authorize?returnUrl=' + url
                // window.location = 'http://ggktbyk.free.idcfengye.com/api/user/openid/authorize?returnUrl=' + url
            }
